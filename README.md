...
![мой результат](images/img6.png)
---

## 4.7. 6 - паттерны Adapter, Strategy, Observer

Реализованы три паттерна проектирования.
